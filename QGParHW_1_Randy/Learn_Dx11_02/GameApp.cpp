...
const D3D11_INPUT_ELEMENT_DESC GameApp::VertexPosColor::inputLayout[2] = { //这里进行输入描述 以对接着色器
...
void GameApp::DrawScene()
{
	...
	m_pd3dImmediateContext->Draw(4, 0);//绘制三角形
	HR(m_pSwapChain->Present(0, 0));//呈现
}
